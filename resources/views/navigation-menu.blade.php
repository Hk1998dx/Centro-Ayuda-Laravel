<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Enlace a la página de administración, solo visible para admin --}}
                    @auth
                        ...
                        <x-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    ...
                                    <x-dropdown-link href="{{ route('teams.show', optional(Auth::user()->currentTeam)->id) }}">{{ __('Team Settings') }}</x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if (Auth::user()->hasRole('admin')) <!-- Verificación del rol 'admin' -->
                    <x-responsive-nav-link href="{{ route('admin.faqs') }}" :active="request()->routeIs('admin.faqs')">
                        {{ __('Administración') }}
                    </x-responsive-nav-link>
                @endif
            @endauth
